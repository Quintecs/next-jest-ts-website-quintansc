  ...
  return (
    <footer data-testid="footerContainer" className="border-t border-edge">
      <div className="site-container py-12">
        ...
        <div className="mt-10 flex flex-col justify-between gap-3 border-t border-edge pt-6 text-xs text-muted"><div className="flex flex-wrap items-center gap-x-6"><Link href="/privacidade" className="text-link text-muted">Privacidade e cookies</Link><CookiePreferencesButton /></div><p>© {new Date().getFullYear()} Quintec — Todos os direitos reservados.</p></div>
      </div>
    </footer>
  );
}
