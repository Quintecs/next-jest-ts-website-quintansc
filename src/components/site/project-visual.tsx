...
export default function ProjectVisual({ project }: { project: Project }) {
  ...
  return (
    <div className={`grid-surface flex min-h-64 flex-col justify-between overflow-hidden p-6 sm:p-8 ${front ? "bg-[#1a2520]" : "bg-[#171f2d]"}`}>
