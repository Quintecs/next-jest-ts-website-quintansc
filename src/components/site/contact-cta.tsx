    ...
    <section className="site-container pb-20 md:pb-28">
      <div className="relative overflow-hidden rounded-2xl border border-primary-light/20 bg-primary/10 px-7 py-12 sm:p-12 lg:p-16">
        <div className="relative flex flex-col justify-between gap-8 lg:flex-row lg:items-end">
          ...
          <Link href="/contato" analyticsEvent={{ name: "contact_click", properties: { location: "bottom_cta", channel: "form" } }} className={cn(buttonVariants(), "primary-cta shrink-0 self-start lg:self-auto")}>Conversar sobre meu projeto <ArrowUpRight size={18} /></Link>
        </div>
      </div>
    </section>
  );
